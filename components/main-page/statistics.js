...
const api = require('../../api-docs.json')
  ...
  render () {
    ...
    return (
      <div className='docContainer'>
        <h1 id='/stats/email_bounces' ref='/stats/email_bounces'>/stats/email_bounces</h1>
        <p>
        ...
        <h1 id='/stats/email_cycle' ref='/stats/email_cycle'>/stats/email_cycle</h1>
        <p>
          The SMTP2GO APIs base URL is <strong>https&#58;//api.smtp2go.com/v3/</strong><br />
          Any API URLs will always be relative to this URL.
        </p>
        ...
        <h1 id='/stats/email_history' ref='/stats/email_history'>/stats/email_history</h1>
        <p>
          The SMTP2GO APIs base URL is <strong>https&#58;//api.smtp2go.com/v3/</strong><br />
          Any API URLs will always be relative to this URL.
        </p>
        ...
        <ul>
          ...
          <div ref='/stats/email_spam'>
            <h1 id='/stats/email_spam'>/stats/email_spam</h1>
          </div>
        <p>
          The SMTP2GO APIs base URL is <strong>https&#58;//api.smtp2go.com/v3/</strong><br />
          Any API URLs will always be relative to this URL.
